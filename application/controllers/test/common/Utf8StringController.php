...
class Utf8StringController extends Rong_Controller
{
    ...
    public function indexAction()
    {
        ...
        $utf8 = new Rong_Common_Utf8String("rong framework是一款框架_分隔_这是rong utf8 string_分隔_子串");
        echo "字符串的值是：" . $utf8 . "<br />";
        ...
        $cmdUtf8String = new Rong_Common_Utf8String("张三四") . "<br />";
        echo "添加Rong_Common_Utf8String: " . $utf8->append( $cmdUtf8String ) . "<br />";
